...
default[:system_core][:packages][:virtualization] = ['libguestfs', 'libvirt', 'libvirt-client', 'python-virtinst', 'virt-manager', 'virt-viewer', 'virt-top', 'qemu-kvm', 'hypervkvpd', 'qemu-guest-agent', 'qemu-kvm-tools']
